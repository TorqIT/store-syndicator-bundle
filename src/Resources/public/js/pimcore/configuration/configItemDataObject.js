...
pimcore.plugin.storeExporterDataObject.configuration.configItemDataObject =
  Class.create(pimcore.plugin.datahub.configuration.graphql.configItem, {
    ...
    buildProductsTab: function () {
      ...
      if (!this.excludeObjectWorkspace) {
        this.excludeObjectWorkspace =
          new pimcore.plugin.storeExporterDataObject.helpers.workspace.object(
            this,
            this.data.products.excludeProducts
          );
      }
      if (!this.classStore) {
        this.classStore = Ext.create("Ext.data.Store", {
          ...
          proxy: {
            ...
            url: Routing.generate(
              "pimcore_storesyndicator_product_choice_get_classes"
            ),
            noCache: false,
            type: "ajax",
            root: "result",
