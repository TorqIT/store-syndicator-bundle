pimcore.registerNS("pimcore.plugin.storeExporterDataObject.helpers.logTab");
...
pimcore.plugin.storeExporterDataObject.helpers.logTab = Class.create(pimcore.bundle.applicationlogger.log.admin, {
    ...
    getTabPanel: function($super) {
        ...
        this.panel.setTitle(t('plugin_pimcore_datahub_configpanel_item_execution_logging'));
